"""Generate test_extreme.py with proper newlines."""
import os

NL = chr(10)  # newline character

test_code = f'''"""Extreme tests for attribute-classifier-mcp.
...
output_path = os.path.join(os.path.dirname(__file__), 'test_extreme.py')
