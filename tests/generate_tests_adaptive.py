"""Generate test_adaptive.py - adaptive training + robust loading tests."""
import os

NL = chr(10)
BSL = chr(92)

test_code = f'''"""Tests for adaptive training config, CPU/GPU modes, and robust file loading."""
import os
import sys
import gc
import json
...
output_path = os.path.join(os.path.dirname(__file__), 'test_adaptive.py')
